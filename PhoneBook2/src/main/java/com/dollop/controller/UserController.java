...
//			
		...
		private void createAccount(HttpServletRequest request, HttpServletResponse response) throws IOException, SQLException {
			User us = new User(request.getParameter("name"), request.getParameter("email"),
					request.getParameter("password"));
			PhoneBookDAO ph = new PhoneBookDAOImpl();
			if (us.getPassward().equals(request.getParameter("cpassword"))) {
				if (ph.save(us) != null) {
